...
def _clone(message, bot, multi=0):
    ...
    if is_gdrive_link(link):
        ...
        sendMessage(
            "Send Gdrive or GDToT/AppDrive/DriveApp/GDFlix/DriveAce/DriveLinks/DriveBit/DriveSharer/HubDrive/DriveHub/KatDrive/Kolop/DriveFire/DriveBuzz Link along with command or by replying to the link by command",
            bot,
            message,
        )
