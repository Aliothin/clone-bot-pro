...
<br><br>
<b>/{BotCommands.UnzipLeechCommand}</b> [download_url][magnet_link]: Start leeching to Telegram and upload the file/folder extracted from any archive extension
<br><br>
<b>/{BotCommands.CloneCommand}</b> [drive_url][gdtot_url]: Copy file/folder to Google Drive
<br><br>
<b>/{BotCommands.BypassCommand}</b> [shorten_url]: Bypass Adf.ly, GPLinks, Rocklinks, Droplink Links
<br><br>
...
botcmds = [
    ...
    (f"{BotCommands.BypassCommand}", "Bypass Shorten Links"),
